...
from .models import Category, CustomerDeliveryForm, CustomerStoreForm, NoticeStore, OrderItem, Rating, RatingStore, Store, Item, DeliveryPerson, Order, Publicity, SubCategory, Suppliment, TypeCategory
from .serializers import CategorySerializer, CustomerDeliveryFormSerializer, CustomerStoreFormSerializer, NoticeStoreSerializer, OrderDeliverySerializer, OrderStatusSerializer, OrderedItemSerializer, RatingSerializer, RatingStoreSerializer, StoreSerializer, ItemSerializer, DeliveryPersonSerializer, OrderSerializer, PublicitySerializer, SubCategorySerializer, SupplimentSerializer, TypeCategorySerializer
